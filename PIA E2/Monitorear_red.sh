...
#Funcion para generar un reeporte del trafico de red usando iftop
function generate_report() {
	...
	echo "Reporte de trafico de red guardado como: $report_file"
}

#Funcion para manejar los errores de datos de entrada en el menu
function handle_error() {
	echo "Opcion invalida, Ingresa alguna de la opciones validas."
}
